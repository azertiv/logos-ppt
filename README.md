...
Seule la bibliothèque défile verticalement, entre le titre et la recherche fixes. La grille monte les lignes visibles et environ un écran de marge de chaque côté, avec navigation par flèches, Début et Fin. Les réglages regroupent Bibliothèque, Recherche IA, Insertion et Affichage, avec des aides « i ». Le raccourci Windows est **Ctrl + Alt + P**, sur les versions PowerPoint compatibles ; le manifeste courant est **1.0.2.0**. Réglages → Insertion affiche la combinaison réellement enregistrée et distingue incompatibilité, action absente et conflit. **Insérer depuis la sélection**, sous la recherche, exécute la même action sans raccourci. Voir [le correctif 1.1.1](docs/CORRECTIFS_1.1.1.md).
